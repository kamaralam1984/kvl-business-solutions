...
const slides = [
  {
    ...
    description: 'KVL Business Solutions provides comprehensive services in Software Development, CCTV & GPS, Civil & Mechanical Work, Manpower Supply, and Events Organizing.',
  ...
  },
  {
    ...
    description: 'Experience seamless integration of technology, infrastructure, and services under one roof with KVL Business Solutions.',
