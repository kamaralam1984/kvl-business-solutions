...
const fallbackDemos = [
  ...
  { _id: 'fb-29', name: 'KVL CRM', description: 'AI-powered enterprise CRM — pipeline, leads and follow-ups managed automatically for modern sales teams', url: 'https://crm.kvlbusinesssolutions.com/', category: 'business', technologies: ['Next.js', 'AI', 'Production'], live: true, iconName: 'Handshake', c1: '#ec4899', c2: '#be185d', order: 4, active: true, startingPrice: 0, image: 'https://images.unsplash.com/photo-1553729459-efe14ef6055d?w=600&h=400&fit=crop&auto=format' },
  { _id: 'fb-30', name: 'KVL GrowthOS', description: 'The AI workforce that grows your business 24/7 — AI agents qualify leads, run outreach and draft proposals around the clock', url: 'https://growthos.kvlbusinesssolutions.com/', category: 'business', technologies: ['Next.js', 'AI Agents', 'Production'], live: true, iconName: 'TrendingUp', c1: '#10b981', c2: '#047857', order: 5, active: true, startingPrice: 0, image: '/website-demos/kvl-growthos.png' },
  { _id: 'fb-31', name: 'KVL Super AI', description: 'A smart AI chatbot you can install on any website in minutes — answers questions, captures leads and speaks every language', url: 'https://superai.kvlbusinesssolutions.com/', category: 'other', technologies: ['AI', 'Chatbot', 'Production'], live: true, iconName: 'Bot', c1: '#6366f1', c2: '#4338ca', order: 6, active: true, startingPrice: 0, image: '/website-demos/kvl-super-ai.png' },
  { _id: 'fb-32', name: 'KVL International School', description: 'A premier CBSE-affiliated school website — admissions, academics and campus life presented with real polish', url: 'https://school.kvlbusinesssolutions.com/', category: 'school', technologies: ['Next.js', 'CMS', 'Production'], live: true, iconName: 'GraduationCap', c1: '#7c3aed', c2: '#4c1d95', order: 7, active: true, startingPrice: 0, image: '/website-demos/kvl-international-school.png' },
  ...
  { _id: 'fb-4', name: 'City Care Multi-Speciality', description: 'Hospital site with online appointments', category: 'hospital', technologies: ['Next.js', 'API'], live: false, iconName: 'Hospital', c1: '#ef4444', c2: '#b91c1c', order: 11, active: true, startingPrice: 19999, image: '/website-demos/city-care.png' },
