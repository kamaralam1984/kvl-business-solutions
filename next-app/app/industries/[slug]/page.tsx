...
const industryDetails: Record<string, IndustryDetail> = {
  ...
  schools: {
    ...
    faq: [
      ...
      { q: 'Is student data kept private and only visible to authorised staff?', a: 'KVL is ISO 27001 certified, and access is role-based, so parents see only their own child\'s records and staff see only what their role requires.' },
    ],
  ...
  hospitals: {
    ...
    faq: [
      { q: 'Is patient data secure and compliant with data protection expectations?', a: 'KVL is ISO 27001 certified, and Hospital Management Software keeps OPD, IPD, pharmacy, lab and billing on one authenticated system rather than scattered paper registers.' },
  ...
  government: {
    ...
    faq: [
      ...
      { q: 'Is data hosted securely for compliance purposes?', a: 'KVL is ISO 27001 certified, and both cloud and on-premise hosting options are available for ERP Software depending on your compliance requirements.' },
    ],
  ...
  finance: {
    ...
    faq: [
      ...
      { q: 'Is the system secure enough for financial and customer data?', a: 'KVL is ISO 27001 certified, and access is role-based, so sensitive loan and customer data is only visible to authorised staff.' },
    ],
