  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-start justify-between gap-4">
        ...
        {!loading && (
          <div className="text-right shrink-0">
            <div className="text-xl font-extrabold" style={{ color: '#f0ede6' }}>{total}</div>
            <div className="text-[11px]" style={{ color: 'rgba(255,255,255,0.35)' }}>{leadCapturedCount} led to a captured lead</div>
          </div>
        )}
      </div>
      ...
      {loading ? (
        ...
        <p className="text-[13px]" style={{ color: 'rgba(255,255,255,0.3)' }}>No conversations yet.</p>
      ) : (
        <div className="space-y-2 stagger-children">
          {logs.map(log => {
            ...
            return (
              <div key={log._id} className="admin-card-hover kpi-enter rounded-2xl overflow-hidden" style={{ background: 'linear-gradient(135deg, #0f0f12 0%, #111114 100%)', border: '1px solid rgba(255,255,255,0.06)' }}>
                <button
                ...
                >
                  <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                      <div className="text-[12.5px] font-medium truncate" style={{ color: 'rgba(255,255,255,0.75)' }}>{firstUserMsg}</div>
                    ...
                    {log.messages.map((m, i) => (
                      <div
                        ...
                        style={{
                          ...
                          background: m.role === 'user' ? 'rgba(200,169,110,0.12)' : 'rgba(255,255,255,0.04)',
