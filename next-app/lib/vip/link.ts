...
export async function linkVisitorToLead(opts: { leadId?: string; dealId?: string; userId?: string; name?: string; email?: string; phone?: string }) {
  ...
  if (opts.phone) set.knownPhone = opts.phone;
