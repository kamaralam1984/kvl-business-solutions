...
export const softwareProducts: Software[] = [
  {
    ...
    description: 'Independence Day special — a clean, mobile-ready 1-page website for any business type (portfolio, restaurant, clinic, agency, personal, or any other niche), live in 3 days. Hosting included free for 1 year; domain not included (connect your own, or we can help you buy one separately). Offer valid till 15 August.',
