...
export const softwareProducts: Software[] = [
  {
    ...
    description: 'A clean, mobile-ready 1-page website for any business type (portfolio, restaurant, clinic, agency, personal, or any other niche), live in 3 days. Hosting included free for 1 year; domain not included (connect your own, or we can help you buy one separately).',
    features: ['1 Page Website', 'Mobile Responsive', 'Contact Form', 'Basic SEO', 'SSL Certificate', 'Social Media Links'],
    price: 999, monthlyRent: 149, unit: '/one-time', rentUnit: '/month',
    tag: 'OFFER', icon: 'Globe', image: 'https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=800&q=80&auto=format&fit=crop', c1: '#f97316', c2: '#c2410c',
    category: 'Website & Design',
    buyOnly: true,
    benefits: [
      { icon: 'Layers', title: 'Fits any business type', desc: 'Portfolio, restaurant, clinic, agency, personal brand — the same 1-page package adapts to your niche.' },
      { icon: 'Rocket', title: 'Live in 3 days', desc: 'A focused 1-page website ships fast — ready to launch within 3 days of order.' },
      { icon: 'Cloud', title: 'Hosting free, no surprise bill', desc: '1 year of hosting is included — no separate hosting invoice to track.' },
    ],
    demoNav: [{ label: 'Preview', icon: 'Globe' }],
  },
  {
    slug: 'website-business-4999',
    name: 'Basic Plan — Business',
    description: 'A 5-page business website — domain included, live in 7 days. Ideal for small businesses that need more than a single landing page: home, about, services, gallery and contact.',
    features: ['5 Pages Website', 'Mobile Responsive', 'Contact Form', 'Basic SEO', 'SSL Certificate', 'Social Media Links', 'Google Maps Integration'],
    price: 4999, monthlyRent: 499, unit: '/one-time', rentUnit: '/month',
    icon: 'Globe', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format&fit=crop', c1: '#22c55e', c2: '#15803d',
    category: 'Website & Design',
    buyOnly: true,
    benefits: [
  ...
  {
    slug: 'website-growth-9999',
    name: 'Premium Plan — Growth',
    description: 'A 10-page growth website with on-page and technical SEO, WhatsApp chat integration and domain included — live in 15 days. Built for businesses ready to invest in real search visibility.',
    features: ['10 Pages Website', 'Mobile Responsive', 'On-page + Technical SEO', 'SSL Certificate', 'Social Media Links', 'Google Maps', 'WhatsApp Chat Integration'],
    price: 9999, monthlyRent: 999, unit: '/one-time', rentUnit: '/month',
    tag: 'POPULAR', icon: 'TrendingUp', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format&fit=crop', c1: '#3b82f6', c2: '#1d4ed8',
    category: 'Website & Design',
    buyOnly: true,
    benefits: [
      { icon: 'Search', title: 'Built to be found', desc: 'On-page and technical SEO from day one, not bolted on later.' },
      { icon: 'MessageSquare', title: 'Chat where customers already are', desc: 'WhatsApp chat integration turns visitors into direct conversations.' },
      { icon: 'Globe', title: 'Domain included', desc: 'No separate domain purchase — it ships ready to go live under your name.' },
    ],
    demoNav: [{ label: 'Preview', icon: 'Globe' }],
  },
  {
    slug: 'website-advanced-14999',
    name: 'Business Plan — Advanced',
    description: 'A 20-page advanced business website with blog integration and unlimited support — domain included. For businesses that need real content depth: multiple services, locations, or a growing blog.',
    features: ['20 Pages Website', 'Mobile Responsive', 'SSL Certificate', 'Social Media Links', 'Google Maps', 'WhatsApp Chat', 'Blog Integration', 'Unlimited Support'],
    price: 14999, monthlyRent: 1499, unit: '/one-time', rentUnit: '/month',
    icon: 'Building2', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format&fit=crop', c1: '#7c3aed', c2: '#5b21b6',
    category: 'Website & Design',
    buyOnly: true,
    benefits: [
      { icon: 'FileText', title: 'Room to grow content', desc: '20 pages plus a blog means you can publish regularly without outgrowing the site.' },
      { icon: 'Headphones', title: 'Unlimited support', desc: 'No support-ticket cap — ongoing help is included, not metered.' },
      { icon: 'Globe', title: 'Domain included', desc: 'No separate domain purchase — it ships ready to go live under your name.' },
    ],
    demoNav: [{ label: 'Preview', icon: 'Globe' }],
  },
  {
    slug: 'website-custom-25000',
    name: 'Custom Plan — Web App',
    description: 'A fully custom, dynamic web application — admin panel, API integrations, payment gateway and advanced features built to your exact spec. Starting price; final quote depends on scope, discussed on a call.',
    features: ['Custom Design', 'Dynamic Pages', 'Admin Panel', 'API Integration', 'Payment Gateway', 'Advanced Features', 'Premium Support'],
    price: 25000, monthlyRent: 2500, unit: '/onwards', rentUnit: '/month',
    tag: 'CUSTOM', icon: 'Code2', image: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80&auto=format&fit=crop', c1: '#f59e0b', c2: '#b45309',
    category: 'Website & Design',
    buyOnly: true,
    noDemo: true,
    benefits: [
      { icon: 'Code2', title: 'Built to your exact spec', desc: 'Custom design and dynamic pages instead of a fixed template — the site works the way your business actually runs.' },
      { icon: 'CreditCard', title: 'Take payments directly', desc: 'A built-in payment gateway means customers can pay on the site itself, not just enquire.' },
      { icon: 'Settings', title: 'You control the content', desc: 'An admin panel means your team updates pages and data without calling a developer every time.' },
    ],
    demoNav: [],
  },
  {
